...
# app.py - where you have create_app() or app = Flask(__name__)
...
def create_app(config_name='default'):
    ...
    # DELETED THE 5 LINES THAT WERE HERE
    ...
    app.register_blueprint(materials_bp) # MOVED HERE - NOW IT WORKS
    ...
    def smtp_test():
        ...
        try:
            ...
            return f"SMTP FAILED: {type(e).__name__}: {str(e)}"

    @app.route('/smtp-test-465')
    def smtp_test_465():
        import socket
        ...
        try:
            ...
            return "PORT 465 SUCCESSFUL"

        except Exception as e:
            return f"PORT 465 FAILED: {type(e).__name__}: {str(e)}"
    ...
    with app.app_context():
        while True:
            try:
                ...
                print(f"Backup skipped: {type(e).__name__} - {e}")
